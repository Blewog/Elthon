...
### write.bold()
write.bold() is also near the same as write.console(), heres an example: write.bold("Hello World") which would print "__Hello World__" just the same as the others but it bolds.
